...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2023 a las 23:58:18
...
INSERT INTO `peliculas` (`pelicula_id`, `titulo`, `descripcion`, `director`, `calificacion`, `id_genero`, `imagen`) VALUES
...
--
ALTER TABLE `peliculas`
  MODIFY `pelicula_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
